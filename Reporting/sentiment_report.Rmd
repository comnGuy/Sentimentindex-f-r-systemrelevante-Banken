...
<!--- Beginn --->
\section{Ergebnisse} 
Das Ziel dieser Ausarbeitung ist es einen Zusammenhang zwischen der Stimmung (\texit{Sentiment}) in den Tweets aus $2012$ und Aktienindizes nachzuweisen.  
...
<<<<<<< HEAD
\section{Wörterbücher}\label{Woerterbuch}
...
>>>>>>> e45235889f4ae171ff02933313fb63df96d58849
...
TODO "Der Kurs ist nicht schlecht! #bitcoin"



\section{Datenaufbereitung}
Um Lokal auf den eigenen Rechner zu arbeiten, war der erste Schritt die Daten auf den Cuda Rechner auf zu splitten in kleinere Pakete. 
