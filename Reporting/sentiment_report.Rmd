...
```
Im Folgendem werden nun die einzelnen Schritte beschrieben, die notwendig sind, um verschiedene Sentimentindizes zu berechnen, auf Basis von Wörterbüchern. Hierzu werden von Hand eigene programmierten Funktionen benutzt.
\begin{itemize}
